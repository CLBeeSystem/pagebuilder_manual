...
|모드|액션|
|----------|-----------------|
|Page|<li>**자동**: 페이지 실행시 자동으로 실행됩니다.</li>* '사운드' 액션의 경우 특정 브라우저에 따라 사용자 동작(클릭, 탭 등)후에 재생이 가능합니다.|
|Touch|<li>**누르기**: 객체 클릭 상태에서 액션이 실행됩니다.</li> <li>**떼기**: 객체에서 버튼 업 상태에서 액션이 실행됩니다. </li> <li>**드래그&드롭**: 객체를 다른 곳으로 끌어다 놓을 때 액션이 실행됩니다. </li> <li>**드래그**: 객체를 드래그 할 때 액션이 실행됩니다.</li> * 드래그&드롭시 드래그 영역과 액션 영역 설정이 가능합니다.(표 하단에 부가설명 이미지가 있습니다.)|
...
<img src='./figure/03-2_1.png' width="800pxpx" >
...
<img src='./figure/5-1-2.jpg' width="300pxpx" >
...
<img src='./figure/5-1-3.jpg' width="300pxpx" >
...
<img src='./figure/5-2.jpg' width="800px">
...
<img src='./figure/5-3전-타켓.jpg' width="500px">
...
### **[페이지]<a id=page></a>**
   ...
   <img src='./figure/5-12.jpg' width='300px'>
...
<img src='./figure/액션타입-1.jpg' width="400px"> px  

액션 타입에서 다양한 움직임 효과를 선택할 수 있습니다.

### **[모든 액션 멈춤]<a id=ahemsdortusajacna></a>**

   <img src='./figure/5-4.jpg' width='300px'>
...
### **[보기/감추기]<a id=qhrlrkacnrl></a>**
  ...
  <img src='./figure/5-5-2.jpg' width='300px'>
  <br>
  <img src='./figure/액션-보기감추기.gif' width='300px'>
...
### **[페이드]<a id=vpdlem></a>**
   ...
   <img src='./figure/5-6-2.jpg' width='300px'>
   <br>
   <img src='./figure/액션-페이드.gif' width='300px'>
...
### **[이동]<a id=dlehd></a>**
   ...
   <img src='./figure/5-7-2.jpg' width='300px'>
   <br>
   <img src='./figure/액션-이동.gif' width='300px'>
...
### **[확대이동]<a id=ghkreodlehd></a>**
   ...
   <img src='./figure/5-8-2.jpg' width='300px'>
   <br>
   <img src='./figure/액션-확대이동.gif' width='300px'>
...
### **[회전]<a id=ghlwjs></a>**
   ...
   <img src='./figure/5-9-2.jpg' width='300px'>
   <br>
   <img src='./figure/액션-회전.gif' width='300px'>
...
### **[뒤집기]<a id=enlwlqrl></a>**
   ...
   <img src='./figure/5-10-2.jpg' width='300px'>
   <br>
   <img src='./figure/액션-뒤집기.gif' width='300px'>
...
### **[애니메이션]<a id=doslapdltus></a>**
   ...
   <img src='./figure/5-11-2.jpg' width='300px'>
   <br>
   <img src='./figure/액션-애니메이션.gif' width='300px'>
...
액션을 정지하거나, 콘텐츠를 바꿀 수 있습니다.
 ...
 <img src='./figure/액션타입-2.jpg' width='400px'>
 ...
 <img src='./figure/액션타입-3.jpg' width='400px'>
