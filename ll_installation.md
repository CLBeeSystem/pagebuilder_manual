...
1. 시작 메뉴를 클릭하여 앞에서 설치한 페이지빌더 바로가기를 클릭해서 실행합니다. <br>
 <br><img src='./figure/1-0.jpg' width="300px"> 

2. 프로그램이 실행되면서 페이지빌더 로딩 페이지가 나타납니다. <br>
 <br><img src='./figure/2-0.jpg' width="400px">
  
3. 로딩페이지 이후에 페이지빌더가 실행됩니다. <br>
 <br><img src='./figure/01-1.jpg' width="800px">
